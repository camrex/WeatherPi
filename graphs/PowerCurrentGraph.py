...
def  PowerCurrentGraph(source,days,delay):
	...
	try:
		...
		pylab.figtext(.5, .05, ("WeatherPi Power Current Last %i Days" % days),fontsize=18,ha='center')
		pyplot.setp( ax.xaxis.get_majorticklabels(), rotation=70)

		pylab.grid(True)

		pyplot.show()
		pyplot.savefig("/home/pi/WeatherPi/state/PowerCurrentGraph.png",facecolor=fig.get_facecolor())	
